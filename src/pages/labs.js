...
<main id="top" class="labs-page">
  ...
  ${section('faq', 'Preguntas frecuentes', 'Lo esencial', `
    <div class="labs-faq">
      ...
      <details><summary>¿NexusG cobra por consumo de tokens?</summary><p><strong>No.</strong></p><p>NexusG funciona sobre clientes compatibles con MCP y aprovecha la suscripción al modelo que la empresa ya utiliza.</p><p>El costo de NexusG corresponde a la plataforma y a las capacidades implementadas. NexusG no cobra por el consumo de tokens de cada consulta.</p></details>
